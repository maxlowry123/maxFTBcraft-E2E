...
# Special Gas Tank Item
	...
	"This item is a crafting ingredient for the Creative Gas Tank. Although JEI says it requires 9 Basic Gas Tanks, it actually requires 9 Filled Ultimate Gas Tanks. The gases you need, from top left to bottom right are: Clean Titanium Slurry, Clean Iridium Slurry, Clean Draconium Slurry, Clean Boron Slurry, Clean Mithril Slurry, D-T Fuel, Ethylene, Sulfuric Acid and Hydrogen Chloride. 512000mb of each.");
...
# NuclearCraft materials
	...
	ad(<nuclearcraft:gem>, atomicReconstructor);
	ad(<nuclearcraft:gem:2>, atomicReconstructor);
	
	ad(<nuclearcraft:dust:9>, metallurgic);
	ad(<nuclearcraft:dust:10>, metallurgic);
