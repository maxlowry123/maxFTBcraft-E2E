...
# *======= Variables =======*
	...
	var ultCube = <mekanism:energycube>.withTag({tier: 3});
...
# Special Gas Tank Item
	...
	[[<mekanism:gastank>.onlyWithTag({tier: 3, mekData: { stored: {amount: 512000, gasName: "slurryCleanTitanium"}}}), <mekanism:gastank>.onlyWithTag({tier: 3, mekData: { stored: {amount: 512000, gasName: "slurryCleanIridium"}}}), <mekanism:gastank>.onlyWithTag({tier: 3, mekData: { stored: {amount: 512000, gasName: "slurryCleanDraconium"}}})],
	[<mekanism:gastank>.onlyWithTag({tier: 3, mekData: { stored: {amount: 512000, gasName: "slurryCleanBoron"}}}), <mekanism:gastank>.onlyWithTag({tier: 3, mekData: { stored: {amount: 512000, gasName: "slurryCleanMithril"}}}), <mekanism:gastank>.onlyWithTag({tier: 3, mekData: { stored: {amount: 512000, gasName: "fusionfuel"}}})], 
	[<mekanism:gastank>.onlyWithTag({tier: 3, mekData: { stored: {amount: 512000, gasName: "ethene"}}}), <mekanism:gastank>.onlyWithTag({tier: 3, mekData: { stored: {amount: 512000, gasName: "sulfuricacid"}}}), <mekanism:gastank>.onlyWithTag({tier: 3, mekData: { stored: {amount: 512000, gasName: "hydrogenchloride"}}})]]);
...
# Mekanism Creative Tank
	...
	[[<industrialforegoing:black_hole_tank>, <forge:bucketfilled>.withTag({FluidName: "milk_goat", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "blood", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "liquiddna", Amount: 1000}), <thermalexpansion:tank>.withTag({RSControl: 0 as byte, Creative: 0 as byte, Fluid: {FluidName: "bio.ethanol", Amount: 32000}, Level: 0 as byte, Lock: 0 as byte}), <forge:bucketfilled>.withTag({FluidName: "juice", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "mutagen", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "biomass", Amount: 1000}), <industrialforegoing:black_hole_tank>], 
...
# Storage Drawers Unlimited Withdrawel Upgrade
	...
	[ultCatalyst, draconicChest, creativeEssence, <mekanism:machineblock2:11>.withTag({tier: 4, mekData: {}}), <ore:ingotInfinity>, <mekanism:gastank>.withTag({tier: 4, mekData: {}}), creativeEssence, draconicChest, ultCatalyst], 
	[ultCatalyst, resonantFrame, <ore:blockAethium>, <draconicevolution:chaotic_core>, benitoite, <draconicevolution:chaotic_core>, <ore:blockAethium>, resonantFrame, ultCatalyst], 
	[blackHoleUnit, resonantFrame, resonantFrame, draconicChest, <extracells:storage.component:3>, draconicChest, resonantFrame, resonantFrame, blackHoleUnit], 
	[<ore:blockCrystalMatrix>, blackHoleUnit, ultCatalyst, ultCatalyst, <bigreactors:minerals>, ultCatalyst, ultCatalyst, blackHoleUnit, <ore:blockCrystalMatrix>]]);
...
# Creative Gas Tank 
	...
	[blockLudicrite, benitoite, gasPad, awakendedCore, <mekanism:machineblock2:11>.withTag({tier: 4}), awakendedCore, gasPad, benitoite, blockLudicrite], 
