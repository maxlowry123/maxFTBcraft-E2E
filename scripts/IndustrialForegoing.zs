import mods.industrialforegoing.LaserDrill as LaserDrill;
...
# Wood Gear
	...
	recipes.addShaped("TeslaCoreLib Wood Gear", <teslacorelib:gear_wood>, [[null, <ore:plankWood>, null],[<ore:plankWood>, null, <ore:plankWood>], [null, <ore:plankWood>, null]]);

# Diamond Gear
	mods.immersiveengineering.MetalPress.addRecipe(<teslacorelib:gear_diamond>, <minecraft:diamond>, <immersiveengineering:mold:1>, 10000, 4);
...
# Black Hole Tank
	...
	[<mekanism:plasticblock:8>, <mekanism:machineblock2:11>.withTag({tier: 3, mekData:{security:0}}), <mekanism:plasticblock:8>]]);
...
# Black Hole Unit
	...
	[[<ore:itemRubber>, <actuallyadditions:item_crystal_empowered:3>, <ore:itemRubber>],
	[<teslacorelib:machine_case>, <botania:blackholetalisman>, <teslacorelib:machine_case>], 
	[<mekanism:plasticblock:8>, <mekanism:basicblock:6>.withTag({tier: 3, mekData: {}}), <mekanism:plasticblock:8>]]);
